...
const AboutSection = () => {
    return (
        <section
            id="about"
            className="w-full py-16 animate__animated animate__fadeInUp animate__delay-1s"
            style={{ backgroundColor: 'rgb(88, 137, 133)' }}
        >
            <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="flex flex-col justify-center">
                    ...
                    <h3 className="text-xl font-semibold text-[#c2e9e4] mb-4">
                        Aura Blossom Spa
                    </h3>

...
const staffMembers = [
    {
        ...
        description: 'Anh Hùng nổi bật với khả năng điều trị mụn hiệu quả, giúp nhiều khách hàng lấy lại làn da sáng mịn, tự tin.',
        image: avt2,
        delay: ''
    },
    {
        ...
        description: 'Anh thành công trong việc cung cấp các liệu trình chăm sóc da toàn diện, giúp làn da khách hàng luôn khỏe mạnh và tươi mới.',
        image: avt1,
    ...
    },
    {
        ...
        description: 'Anh Vinh nổi bật với kỹ thuật tẩy lông vĩnh viễn, giúp khách hàng loại bỏ lông một cách an toàn và lâu dài, mang lại làn da mịn màng, tự tin.',
        image: avt3,
...
const StaffSection = () => {
    return (
        <section id="staff" className="py-16 px-4 animate__animated animate__fadeInUp animate__delay-2s" style={{ backgroundColor: 'rgb(142, 163, 150)' }}>
